    ...
    if (startCoords && endCoords) {
        ...
        routingControl = L.Routing.control({
         ...
         routingControl.on('routesfound', function(e) {
            ...
            alert('ขึ้นรถสายสีเหลือง ลงรถที่จุดเกษตรศาสตร์2 ขึ้นรถสายสีเขียว');
        });
    }
}
