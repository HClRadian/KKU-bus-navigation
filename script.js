...
// ฟังก์ชันแปลงชื่อสถานีเป็นพิกัด
...
// สร้างเส้นทางให้กับแต่ละคันด้วยสีที่แตกต่างกัน
createRoute(convertToLatLngArray(routes.bus1), 'red');    // เส้นทางของ bus1
createRoute(convertToLatLngArray(routes.bus2), 'blue');   // เส้นทางของ bus2
createRoute(convertToLatLngArray(routes.bus3), 'green');  // เส้นทางของ bus3
createRoute(convertToLatLngArray(routes.bus4), 'orange'); // เส้นทางของ bus4
